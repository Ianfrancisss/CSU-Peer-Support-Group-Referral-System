    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item dropdown mt-2">
            ...
            <ul class="dropdown-menu" aria-labelledby="settingsDropdown">
                ...
                <li><a class="dropdown-item" href="{{ route('deleteconfirm') }}" data-bs-toggle="modal" data-bs-target="#deleteModal"><i class="fas fa-user-times me-2"></i> Delete Account</a></li>
            </ul>
        </li>
    </ul>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered"> <!-- Center the modal vertically -->
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <form action="{{ route('deleteconfirm') }}" method="POST" class="text-center">
                    @csrf
